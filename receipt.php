                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="invoice-footer mt25">
                                                <p class="text-center">Generated on <?php date_default_timezone_set('Asia/Jakarta'); echo $date = date('Y-m-d H:i:s');?>
                                                <a onclick="print()" class="btn btn-default ml15"><i class="fa fa-print mr5"></i> Print</a></p>
                                            </div>
                                        </div>
                                        <!-- col-lg-12 end here -->
                                    </div>
